...
<script type="text/javascript">
    ...
    foreach ($data as $row) {
        ...
        echo "var marker = L.marker([" . $row['lat'] . ", " . $row['lng'] . "]).addTo(map).bindPopup('<b>" . $row['nama_kantordesa'] . "</b><br><img src=\"../file/" . $row['foto'] . "\" alt=\"Foto\" style=\"width: 100px; height: auto;\"><br>" . $row['alamat'] . "');";
    } 
    ?>
